...
public class MismatchingRegistrationBoundaryExceptionTest {
    ...
    public void testMismatchingRegistrationBoundaryException() {
        ...
        Assert.assertEquals("Mismatching timestamps; incoming registration " + checksum2 + " with registrationFrom 2018-01-01T00:00:00Z does not match existing registration " + checksum1 + " with registrationTo 2017-12-31T23:59:59Z", exception.getMessage());
